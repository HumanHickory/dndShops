...
function BuildHeader() {
    ...
    nav += "<a class='navbar-brand' href='" + root + "Cities/Oclul/index.html'>Oclul</a>";
    ...
    nav += "<a class='nav-link' href='" + root + "Cities/Oclul/index.html'>Home</a>";
    nav += " </li>";
   // nav += "<li class='nav-item'>";
   // nav += "<a class='nav-link' href='" + root + "Cities/Oclul/government.html'>Government</a>";
   // nav += "</li>";
    nav += "<li class='nav-item'>";
    nav += "<a class='nav-link' href='" + root + "Cities/Oclul/index.html#history'>History</a>";
    nav += " </li>";
    nav += "<li class='nav-item'>";
    nav += "<a class='nav-link' href='" + root + "Cities/Oclul/News.html'>Weekly News</a>";
    nav += "</li>";
    ...
    nav += "<a class='dropdown-item' href='" + root + "/townIndex/Oclul.html'>Shopping</a>";
    nav += "<a class='dropdown-item' href='" + root + "shops/taverns/WindyHyena_Oclul.html'>Eats and Drinks</a>";
    nav += "</div>";
    nav += "</li>";
    ...
    //nav += "</a>";
    //nav += "<div class='dropdown-menu' aria-labelledby='navbarDropdown'>";
    //nav += " <a class='dropdown-item' href='" + root + "Guilds/Oclul/FightersGuild.html'>Knights of the Lost Age</a>";
    //nav += " <a class='dropdown-item' href='" + root + "Guilds/Oclul/GuildOfMysticArts.html'>Academy of Mystic Arts</a>";
    //nav += " <a class='dropdown-item' href='" + root + "Guilds/Oclul/CDEU.html'>The Coalition</a>";
    //nav += "</div>";
    //nav += "</li>";
