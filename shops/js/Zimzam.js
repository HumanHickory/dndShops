...
$(document).ready(function () {
    ...
    function Arynsport() {
        ...
        var html = CreateItemBlock(itemName1, itemPrice1, itemName2);
    ...
    function Rivvenastorp() {
        ...
        var itemPrice5 = "50gp";
        var itemDesc5 = "A wind up device. The user may fill the device with 1 to 50 darts. Once wound, the user has 1 minute to get out of the way. Then, the device will begin shooting darts in every circle, shooting up to 3 darts each round in one direction and then changing directions. It will shoot all the darts it is loaded with and cannot be stopped unless broken, frozen, etc.";
